...
*Menampilkan hasil pengmabilan data secara realtime dari API Publik.*
...
## ✍ Kendala dan Sousi
1.*Kendala*: Navigasi Error: Menu "Identitas Peserta" tidak bisa diklik atau File Not Found.
